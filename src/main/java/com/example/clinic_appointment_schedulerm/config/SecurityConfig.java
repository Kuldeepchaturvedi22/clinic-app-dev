    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
          ...
          .authorizeHttpRequests(auth -> auth
                  ...
                  .requestMatchers("/api/ai-chat/test", "/api/ai-chat/config").permitAll()
                  .requestMatchers(HttpMethod.GET, "/api/doctors/**", "/api/patients/**").authenticated()
                  .requestMatchers("/api/appointments/**", "/api/ai-chat/**", "/api/help-chat/**", "/api/ratings/**", "/api/chat/**", "/api/admin/**").authenticated()
