        ...
        <div className="page-container">
            ...
            <div className="grid grid-2" style={{marginBottom: '3rem'}}>
                ...
                <div className="card" style={{textAlign: 'center'}}>
                    ...
                    <p>Get instant AI-powered health insights by describing your symptoms. Receive possible causes and general recommendations 24/7.</p>
                    <Link to="/ai-chat" className="btn btn-secondary" style={{marginTop: '1rem'}}>Try AI Assistant</Link>
                </div>
            </div>
